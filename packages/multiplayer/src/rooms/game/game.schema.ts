...
export class GameRoomState extends Schema {
	@type({ map: SchemaPlayer }) players: MapSchema<SchemaPlayer, string> = new MapSchema()
	@type({ map: SchemaBullet }) bullets: MapSchema<SchemaBullet, string> = new MapSchema()
}
